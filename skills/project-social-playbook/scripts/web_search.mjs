#!/usr/bin/env node
// Tiered web search for project/background enrichment. Degrades gracefully.
//
// Usage:
...
async function main() {
  ...
  return emit({
    ...
    query,
    results: [],
    note: "No web-search API key set. Skipping background enrichment; continue with user-provided inputs and the bundled launch library.",
  });
}
