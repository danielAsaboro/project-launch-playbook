#!/usr/bin/env node
/**
 * MCP server for the project-social-playbook skill.
 *
...
async function webSearch(query, max) {
  ...
  return {
    ...
    query,
    results: [],
    note: "No web-search API key configured. Skipping background enrichment; continue with user-provided inputs and the bundled launch library.",
  };
}
